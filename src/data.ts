...
export const shuttleData: Shuttle[] = [
  ...
  { category: '市内班车（周一至周五）', busName: '4号车', plateNumber: '皖A16958', departureTime: '07:05', departureLocation: '科大南区南门(水阳江路)', arrivalLocation: '等离子体所四号楼(北广场)', stops: ['徐州大道', '三里庵', '大铺头311站牌停靠(永达商场对面)', '智能所', '安光所', '二号楼', '交叉楼', '三号食堂'], note: '三里庵预计07:30到达' },
  { category: '市内班车（周一至周五）', busName: '4号车', plateNumber: '皖A16958', departureTime: '17:02', departureLocation: '等离子体所四号楼(北广场)', arrivalLocation: '科大南区南门(水阳江路)', stops: ['交叉楼', '三号楼', '安光所', '智能所', '三里庵', '徐州大道'] },
  { category: '市内班车（周一至周五）', busName: '5号车', plateNumber: '皖AH5271', departureTime: '07:15', departureLocation: '科大东区(北门)', arrivalLocation: '等离子体所四号楼(北广场)', stops: ['大润发', '潜山路洞河路交口', '金色池塘', '智能所', '安光所', '综合楼', '二号楼', '交叉楼', '三号食堂'] },
  { category: '市内班车（周一至周五）', busName: '5号车', plateNumber: '皖AH5271', departureTime: '17:04', departureLocation: '等离子体所四号楼(北广场)', arrivalLocation: '科大东区(北门)', stops: ['二号楼', '安光所', '智能所', '金色池塘', '潜山路洞河路交口', '科大北区'] },
  ...
  { category: '聚贤苑—聚变堆园区（北门）班车（周一至周五）', busName: '2号车', plateNumber: '皖AH1841', departureTime: '11:20', departureLocation: '聚变堆园区(北门)', arrivalLocation: '科大东区(北门)', stops: ['等离子体所四号楼(北广场)', '固体所', '强磁场', '三号楼', '安光所', '智能所', '聚贤苑', '科学家园', '科大西区(北门)'] },
